...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-white">
      {/* Hero Section */}
      <section className="flex flex-col items-center py-16 bg-gray-100 dark:bg-gray-800 w-full px-4">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-5xl font-bold text-green-600 dark:text-lime-200 mb-6">Linkarooie</h1>
          <img
            src={heroImage}
            alt="Linkarooie"
      ...
      <section className="py-16 px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800 dark:text-white">Explore Profiles</h2>
      ...
      <section className="py-16 px-4 bg-gray-50 dark:bg-gray-900 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a
            ...
            className="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white font-bold py-2 px-4 rounded inline-flex items-center space-x-2 transition duration-300"
          >
